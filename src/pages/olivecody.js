  ...
  <React.Fragment>
    ...
    <section id="whoAreWe">
      <div>
        <h2>Who Are We?</h2>
        <h3>
          Hey all, thanks for dropping by. We are Olive and Cody, brother and
          sister and we enjoy programming together.
        </h3>
    ...
    <section id="mascots">
      <div class="row">
        <div class="column">
          ...
          <h3>
            ..or Liv to my friends. I love to game and to code my own games.
          </h3>
        </div>
        ...
        <div class="column">
          ...
          <h3>
            We find it's really good to help each other out, so we pair program
            as well.
          </h3>
        </div>
      </div>
